...
public class AppUtils {
    ...
    public static boolean installApk(Context context, String filePath) {
        //如果Accessibility可使用，则智能安装，否则跳转到"无障碍"设置页
        if (isAccessibilityEnabled(context, com.cniao5.cniao5play.service.InstallAccessibilityService.class.getCanonicalName())) {
    ...
    public static void cleanInstallPackage(String path) {
        FileUtils.deleteFileByDirectory(new File(path));
    }
    ...
    public static List<AndroidApk> getInstalledApps(Context context) {
        ...
        //使用这种方法排序小实现comparable接口
        Collections.sort(apks);

//        Collections.sort(apks, new Comparator<AndroidApk>() {
//            @Override
//            public int compare(AndroidApk o1, AndroidApk o2) {
//
//                return (o1.isSystem() && !o2.isSystem()) ? 1 : -1;
//            }
//        });
        return apks;
