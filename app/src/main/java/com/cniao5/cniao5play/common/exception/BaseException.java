...
public class BaseException extends Exception {
    ...
    /*无数据*/
    public static final int NO_DATA = 0x9;
    ...
    /**
     * 传入的displayMessage 只有在 Observable.error(new ApiException(tBaseBean.getStatus(), tBaseBean.getMessage()))
     * 才有用，其余在ErrorMessageFactory 的 setDisplayMessage()时才有用
     * @param code
